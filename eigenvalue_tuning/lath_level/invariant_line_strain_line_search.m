                ...
                while ( ( res_old > vec_residual )  ...
                    ...
                    if(new_res_dS1 < new_res_dS2)
                        ...
                        if ( res_old < new_res_dS1 ) % ( ( lambda2_smaller1_shear1 ~= lambda2_smaller1_initial ) ||
                            ...
                            [delta_eps, R_dS, res_new, dS1] = linesearch_ILS( martensite.U, S(:,:,is1), S_accummulated, u, delta_eps, new_res_dS1, vec_residual);
                            %if (res_old - res_new) > vec_residual
                                res_old = res_new;
                                eps1 = eps1 + delta_eps;
                        ...
                        if ( res_old < new_res_dS2 ) % ( ( lambda2_smaller1_shear2 ~= lambda2_smaller1_initial ) ||
                            ...
                            [delta_eps, R_dS, res_new, dS2] = linesearch_ILS( martensite.U, S(:,:,is2), S_accummulated, u, delta_eps, new_res_dS2, vec_residual);
                            %if (res_old - res_new) > vec_residual
                                res_old = res_new;
                                eps2 = eps2 + delta_eps;
