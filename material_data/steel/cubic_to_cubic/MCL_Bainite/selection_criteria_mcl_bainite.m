...
theta_CPPs_max = 0.74 % 0.5; %3.; %1.; % 90.;  maximum misorientation angle of CP relation - due to Qi,Khachaturyan 2013
...
theta_h_to_CPP = 20.; % Dominik: 4-21°  ;  normally between 10 and 20 - see Maresca paper.;  
...
theta_KS_max = 2.2; % 5.26; %3.5; % 10.;  had 6 here in last calculations


%% Not specified in Meeting 22.09.2021

% maximum value of shape strain of deformation (lambda1-lambda3) - property
% name is eps_ips
% set numerical upper bound 
eps_ips_max = 0.65; % 0.3;  Very high value (upper bound) 
...
eps_s_max = 0.4; % single maximal slip system magnitude 
eps_s_sum_max = 0.4; % maximal sum of both slip system magnitude (not total shape strain, since no Bain strain involved) 

% NOTE also check absolute bounds of g_min and eps_max in numerical
% parameters!!!!!!

 max_rot_angle_lath = 15.; % this value should generally be as low as possible! How to argue that a lath rotates at all? 
 % however not specified around which direction! e.g. easier in direction of smallest dimension! 
