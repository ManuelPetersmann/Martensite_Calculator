...
%eps_max_solutions = Solution_array( Slip_solution(), g_min_sols, 'eps', eps_max, 'max' ); % for MARESCA&CURTIN RUN
...
mc_sols = det_sols.sort( 'theta_n' ) % sort in ascending order for specific property
