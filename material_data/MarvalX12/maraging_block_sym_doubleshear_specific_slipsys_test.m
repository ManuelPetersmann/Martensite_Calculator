...
% the plane and direction families for P^(2) are {110}_alpha and <111>_alpha
...
% following Maresca&Curtin (2017) we consider
% the plane and direction families for P^(3) are {111}_gamma and <101>_gamma
...
ms = cat(1, ms, all_from_family_perms( [1 1 2], sort_out_negatives ) ); % 17.08.2017 - (001)_aust mirror planes transform to (112)_mart 
...
all_sols_specific_slipsys = block_symmetric_doubleshear_specific_slipsys(martensite.U, martensite.cp, ms, ns_P2, ds_P2, ns_P3, ds_P3 );
...
g_min_sols = Solution_array( Slip_solution_doubleshear(), all_sols_specific_slipsys, 'g', g_min, 'min'); 
...
% % % % % eps_max_solutions_test = Solution_array( Slip_solution_doubleshear(), all_sols, 'eps', eps_max, 'max' ); 
% % % % % eps_max_solutions_test_crit1 = Solution_array( Slip_solution_doubleshear(), g_min_sols, 'eps', eps_max, 'max' ); 
...
theta_p_sols = Solution_array( Slip_solution_doubleshear(), eps_max_solutions, cpps_gamma, theta_p_max, 'theta_p', 'closest_to_cpp', 'cpps_gamma', true);
% % % % % theta_p_sols_crit2 = Solution_array( Slip_solution_doubleshear(), all_sols, cpps_gamma, theta_p_max, 'theta_p', 'closest_to_cpp', 'cpps_gamma', true);
...
theta_KS_sols = Solution_array( Slip_solution_doubleshear(), theta_p_sols, KS, theta_KS_max, 'theta_KS_min', 'closest_KS', 'KS', false );
% % % % % theta_KS_sols_test = Solution_array( Slip_solution_doubleshear(), all_sols, KS, theta_KS_max, 'theta_KS_min', 'closest_KS', 'KS', false );
% % % % % theta_KS_sols_crit2 = Solution_array( Slip_solution_doubleshear(), theta_p_sols_crit2, KS, theta_KS_max, 'theta_KS_min', 'closest_KS', 'KS', false );
...
% % % % % theta_NW_sols_test = Solution_array( Slip_solution_doubleshear(), all_sols, NW, theta_NW_max, 'theta_NW_min', 'closest_NW', 'NW', false);
% % % % % theta_NW_sols_test_crit2 = Solution_array( Slip_solution_doubleshear(), theta_KS_sols_crit2, NW, theta_NW_max, 'theta_NW_min', 'closest_NW', 'NW', false);
...
cpp_deviation_sols = Solution_array( Slip_solution_doubleshear(), theta_NW_sols, cpps_gamma, theta_n_max, 'theta_n', 'closest_to_h', 'h'); 
...
% % % % % cpp_deviation_sols_test_crit3 = Solution_array( Slip_solution_doubleshear(), all_sols, cpps_gamma, theta_n_max, 'theta_n', 'closest_to_h', 'h'); 
...
det_sols = Solution_array( Slip_solution_doubleshear(), cpp_deviation_sols, 'det', delta_determinant_max,  detB3 ); 
% % % % % det_sols_test_crit4 = Solution_array( Slip_solution_doubleshear(), all_sols, 'det', delta_determinant_max,  detB3 ); 
%
