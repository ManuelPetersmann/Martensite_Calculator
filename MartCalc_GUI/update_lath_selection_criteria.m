        ...
        if ~isempty(handles.martensite.IPS_solutions.array) %solutions_available
            ...
            if handles.asc_number_IPS > 0
                ...
                if(handles.asc_status_IPS(1) > 0)
                    ...
                    crit  = get(handles.asc_status_IPS(1).Chidren(2),'String');
                    min_stepwidth = str2double( childs( seize - crit ) );
                end
                ...
                if(handles.asc_status_IPS(2) > 0)
                    ...
                    crit  = get(handles.asc_status_IPS(2).Chidren(2),'String');
                    eps_ips_max = str2double( childs( seize - crit ) );
                end
                ...
                if(handles.asc_status_IPS(3) > 0)
                    ...
                    crit  = get(handles.asc_status_IPS(3).Chidren(2),'String');
                ...
                if(handles.asc_status_IPS(4) > 0)
                    ...
                    crit  = get(handles.asc_status_IPS(4).Chidren(2),'String');
                    theta_h_to_cpp = str2double( childs( seize - crit ) );
                end
                ...
                if(handles.asc_status_IPS(5) > 0)                                        
                    ...
                    crit  = get(handles.asc_status_IPS(5).Chidren(2),'String');
                    theta_KS_max = str2double( childs( seize - crit ) );
                end
                ...
                if(handles.asc_status_IPS(6) > 0)                                        
                    ...
                    crit  = get(handles.asc_status_IPS(6).Chidren(2),'String');
                    theta_NW_max = str2double( childs( seize - crit ) );
                end
                ...
                if(handles.asc_status_IPS(7) > 0)                                        
                    ...
                    crit  = get(handles.asc_status_IPS(7).Chidren(2),'String');
                    theta_max_ILSdir_to_h = str2double( childs( seize - crit ) );
                end
        ...
        if ~isempty(handles.martensite.ILS_solutions.array)
            ...
            if handles.asc_number_ILS > 0           
                ...
                if (handles.asc_status_ILS(1) > 0)
                    ...
                    crit  = get(handles.asc_status_ILS(1).Chidren(2),'String');
                    min_stepwidth = str2double( childs( seize - crit ) );
                end
                ...
                if (handles.asc_status_ILS(2) > 0)
                    ...
                    crit  = get(handles.asc_status_ILS(2).Chidren(2),'String');
                    theta_CPPs_max = str2double( childs( seize - crit ) );
                end
                ...
                if (handles.asc_status_ILS(3) > 0)
                    ...
                    crit  = get(handles.asc_status_ILS(3).Chidren(2),'String');
                ...
                if (handles.asc_status_ILS(4) > 0)
                    ...
                    crit  = get(handles.asc_status_ILS(4).Chidren(2),'String');
