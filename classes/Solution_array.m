...
%                     end
                    ...
                    if nargin == 7
                        ...
                        % vector ('h' or 'd' in (7))
                        %
                        %[a, b] = min_misorientation( varargin{3}, varargin{2}.array(i).(varargin{7}) )
                        %varargin{2}.array(i).added_props(varargin{5}) = a;
                        %varargin{2}.array(i).added_props(varargin{5})
                        %varargin{2}.array(i).added_props(varargin{6}) = b;
                        [ varargin{2}.array(i).added_props(varargin{5}), varargin{2}.array(i).added_props(varargin{6}) ] = ...
