...
% given an array of vectors "vecs" representing families of directions or planes
...
% Alternatively 'comp' can be a lattice transformation matrix, used with
% a third argument "plane", a boolean specifying wheter the mapping is 
% applied to planes (true) or directions (false) to determine angles 
% between vectors in the parent and product phase.
